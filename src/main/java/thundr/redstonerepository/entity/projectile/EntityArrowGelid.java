...
public class EntityArrowGelid extends EntityArrow {
    ...
    public EntityArrowGelid(World world, boolean empowered) {
        super(world);
    ...
    public EntityArrowGelid(World world, double x, double y, double z, boolean empowered) {
        super(world, x, y, z);
        this.empowered = empowered;
        setDamage(empowered ? DAMAGE_EMPOWERED : DAMAGE);
        setNoGravity(true);
    ...
    public EntityArrowGelid(World world, EntityLivingBase shooter, boolean empowered) {
        super(world, shooter);
        this.empowered = empowered;
        setDamage(empowered ? DAMAGE_EMPOWERED : DAMAGE);
        setNoGravity(true);
