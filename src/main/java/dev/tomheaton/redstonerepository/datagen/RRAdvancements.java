...
public class RRAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        // Redstone Repository:
        Advancement root = rootAdvancement(consumer, RegistryHandler.FLUX_STRING.get(), "root", null, "stone", FrameType.TASK, "crafting_table", InventoryChangeTrigger.Instance.hasItems(Blocks.CRAFTING_TABLE));
        Advancement test = itemAdvancement(consumer, root, RegistryHandler.FLUX_STRING.get(), "redstonerepository", FrameType.CHALLENGE);
        Advancement test_two = itemAdvancement(consumer, root, RegistryHandler.GELID_OBSIDIAN_ROD.get(), "redstonerepository", FrameType.CHALLENGE);
}
